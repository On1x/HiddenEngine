	...
	exec(callback){
		...
		if(this.session.auth){
			...
			if(2==global.he.watch_manager.steem){
				this.content+=`continuing on block id: #`+global.he.steem_watch_block_id+`, refresh page later`;
			}
			if(1==global.he.watch_manager.steem){
				this.content+=`working, block id: #`+global.he.steem_watch_block_id+`, actions: <a href="/watch-control/?action=stop&id=steem">stop</a>`;
			}
			if(0==global.he.watch_manager.steem){
				this.content+=`stopped on block id: #`+global.he.steem_watch_block_id+`, actions: <a href="/watch-control/?action=continue&id=steem">continue</a>, <a href="/watch-control/?action=restart&id=steem">restart</a>`;
			}
			this.content+=`</li>`;
			this.content+=`<li>Golos: `;
			if(2==global.he.watch_manager.golos){
				this.content+=`continuing on block id: #`+global.he.golos_watch_block_id+`, refresh page later`;
			}
			if(1==global.he.watch_manager.golos){
				this.content+=`working, block id: #`+global.he.golos_watch_block_id+`, actions: <a href="/watch-control/?action=stop&id=golos">stop</a>`;
			}
			if(0==global.he.watch_manager.golos){
				this.content+=`stopped on block id: #`+global.he.golos_watch_block_id+`, actions: <a href="/watch-control/?action=continue&id=golos">continue</a>, <a href="/watch-control/?action=restart&id=golos">restart</a>`;
			}
			this.content+=`</li>`;
			this.content+=`</ul>`;
		}
